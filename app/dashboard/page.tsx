...
export const metadata: Metadata = {
  ...
  description: "Student management dashboard overview",
}
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Computer Science, Mathematics, Physics, Chemistry, Biology</p>
          </CardContent>
          <CardFooter>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-sm text-muted-foreground">
              Add a new student to the system with their course details and contact information.
            </div>
          </CardContent>
          <CardFooter>
            <Button asChild className="w-full">
              <Link href="/dashboard/add-student">Add new student</Link>
            </Button>
          </CardFooter>
        </Card>
      </div>
